...
const ClientTestimonailSection = () => {
  ...
  return (
    <div className="py-12 sm:py-25 bg-gray-50">
      <div className={`${sectionContainer} ${sectionPaddingX} embla`}>
        <div className="flex flex-col gap-8 sm:gap-12.5">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 sm:gap-10">
            <h3 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-gray-900 leading-tight">
              {t('clientTestimonialsTitle', 'Client Testimonail')}
            </h3>
